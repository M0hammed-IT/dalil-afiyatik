...
<head>
    ...
    <title>دليل عافيتك | التخصصات الطبية</title>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="sideMenu">
    ...
    <div class="offcanvas-body mt-3">
        <ul class="list-unstyled fw-bold">
            ...
            <li class="mb-4"><a href="{{ url('/specialties') }}" class="text-decoration-none d-block" style="color: var(--primary-navy);"><i class="fa-solid fa-stethoscope ms-3 w-25" style="color: var(--accent-gold);"></i> التخصصات الطبية</a></li>
...
<nav class="navbar navbar-expand-lg custom-navbar sticky-top py-3 bg-white shadow-sm">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse justify-content-end d-none d-lg-flex" id="navbarNav">
            <ul class="navbar-nav align-items-center gap-2">
                ...
                <li class="nav-item"><a class="nav-link fw-bold" href="{{ url('/specialties') }}" style="color: var(--primary-navy); border-bottom: 2px solid var(--accent-gold);">التخصصات</a></li>
    ...
    <header class="inner-page-header fade-up">
        <div class="container">
            <h1 class="fw-bold display-5">التخصصات الطبية</h1>
            <p class="opacity-75 fs-5">ابحث عن الطبيب المناسب حسب القسم الطبي</p>
        </div>
    </header>

    <main class="specialties-section">
        <div class="container">
            <div class="row g-4 justify-content-center">
                @foreach($specialties as $specialty)
                <div class="col-lg-4 col-md-6 fade-up" style="transition-delay: {{ $loop->index * 0.1 }}s;">
                    <a href="{{ url('/doctors?specialty=' . $specialty->id) }}" class="text-decoration-none">
                        <div class="spec-grid-card shadow-sm">
                            <div class="spec-icon-wrap">
                                <i class="fa-solid {{ $specialty->icon }}"></i>
                            </div>
                            <h3 class="spec-title">{{ $specialty->name }}</h3>
                            <div class="mb-3">
                                <span class="spec-count">{{ $specialty->doctors_count }} طبيب متوفر</span>
                            </div>
